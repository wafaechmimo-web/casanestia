...
import essaouiraAsset from "@/assets/city-essaouira.png.asset.json";
const essaouiraImg = essaouiraAsset.url;
...
import bouskouraAsset from "@/assets/city-bouskoura.png.asset.json";
const bouskouraImg = bouskouraAsset.url;
